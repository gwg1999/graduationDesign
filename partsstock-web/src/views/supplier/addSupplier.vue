    ...
    <div class="app-container" style="width: 70%;position: absolute;left: 200px;top: 60px">
      <el-form  ref="supplier" :model="supplier" label-width="120px" :rules="rules">
        <div style="width: 50%;float: left">
          ...
          <el-form-item label="负责人" prop="sPersionName">
            <el-input v-model="supplier.sPersionName" style="width: 300px"/>
          </el-form-item>
...
<!--            <el-input v-model="supplier.cModelName" style="width: 300px"/>-->
<!--          </el-form-item>-->
        </div>
        <div style="width: 50%;float: right">
<!--          <el-form-item label="车价格" prop="cPrice">-->
<!--            <el-input v-model="supplier.cPrice" style="width: 300px"/>-->
<!--          </el-form-item>-->
<!--          <el-form-item label="车状态" prop="cStatus">-->
<!--            <el-input v-model="supplier.cStatus" style="width: 300px"/>-->
<!--          </el-form-item>-->
<!--          <el-form-item label="车类型ID" prop="cTypeId">-->
<!--            <el-input v-model="supplier.cTypeId" style="width: 300px"/>-->
<!--          </el-form-item>-->
<!--          <el-form-item label="车类型名" prop="cTypeName">-->
<!--            <el-input v-model="supplier.cTypeName" style="width: 300px"/>-->
<!--          </el-form-item>-->
...
export default {
  ...
  methods: {
    save(){
      ...
      this.$router.push({path:'/maintain/supplier'})
    },
    submitForm(formName) {
